...
export function AnnouncementContent({ content: Silian_content, contentFormat: Silian_contentFormat = Silian_ANNOUNCEMENT_CONTENT_FORMAT_TEXT, className: Silian_className }) {
  const Silian_renderedHtml = Silian_useMemo(
    () => Silian_renderAnnouncementContentHtml(Silian_content, Silian_contentFormat),
    [Silian_content, Silian_contentFormat]
  );
  ...
  return (
    <div
      ...
      dangerouslySetInnerHTML={{ __html: Silian_renderedHtml }}
    />
  );
}
